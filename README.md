...
```
https://raw.githubusercontent.com/slimshady2121/multi-proxy-config-fetcher/refs/heads/main/configs/proxy_configs.txt
```
...
```
https://raw.githubusercontent.com/slimshady2121/multi-proxy-config-fetcher/refs/heads/main/configs/singbox_configs.json
```
